...
namespace AssessmentPersistence.Migrations
{
    ...
    [Migration("20201207132711_AddQuestionnaireDomrelationShipToDomTable")]
    partial class AddQuestionnaireDomrelationShipToDomTable
    {
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentAnswer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AnswersJson = "[{}]", ApproverTwwId = 0, AssessmentUserStatusId = 1, DateCreated = new DateTime(2020, 12, 7, 13, 27, 10, 641, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 13, 27, 10, 640, DateTimeKind.Utc), IsActive = true, ModifiedBy = 10146063, TotalScore = 0 }
                    );
                });
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentUserStatus", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 13, 27, 10, 640, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 13, 27, 10, 639, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999996, StatusId = 2, UserId = 99999992, UserRegionId = 1, formChanged = false },
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.LookUpTables.AssessmentLinkForm", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 12, 7, 13, 27, 10, 666, DateTimeKind.Utc));
