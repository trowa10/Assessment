...
namespace AssessmentPersistence.Migrations
{
    ...
    [Migration("20200608123102_AlterAssessmentAnswerAddApproverTwwIdField")]
    partial class AlterAssessmentAnswerAddApproverTwwIdField
    {
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentAnswer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AnswersJson = "[{}]", ApproverTwwId = 0, AssessmentUserStatusId = 1, DateCreated = new DateTime(2020, 6, 8, 12, 31, 1, 833, DateTimeKind.Utc), DateModified = new DateTime(2020, 6, 8, 12, 31, 1, 833, DateTimeKind.Utc), IsActive = true, ModifiedBy = 10146063, TotalScore = 0 }
                    );
                });
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentTemplate", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AssessmentCode = "PA2020", DateCreated = new DateTime(2020, 6, 8, 12, 31, 1, 831, DateTimeKind.Utc), DateModified = new DateTime(2020, 6, 8, 12, 31, 1, 831, DateTimeKind.Utc), EndDate = new DateTime(2020, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, ModifiedBy = 10146063, ScoreCriteriaId = 1, StartDate = new DateTime(2020, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Performance Appraisal", Version = "1.0", Year = 2020 },
                        new { Id = 2, AssessmentCode = "SD2020", DateCreated = new DateTime(2020, 6, 8, 12, 31, 1, 831, DateTimeKind.Utc), DateModified = new DateTime(2020, 6, 8, 12, 31, 1, 831, DateTimeKind.Utc), EndDate = new DateTime(2020, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, ModifiedBy = 10146063, ScoreCriteriaId = 1, StartDate = new DateTime(2020, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Salary Discussion", Version = "1.0", Year = 2020 }
                    );
                });
