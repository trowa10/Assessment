...
namespace AssessmentPersistence.Migrations
{
    ...
    [Migration("20201207115751_AddNewTableQuestionnaire")]
    partial class AddNewTableQuestionnaire
    {
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentAnswer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AnswersJson = "[{}]", ApproverTwwId = 0, AssessmentUserStatusId = 1, DateCreated = new DateTime(2020, 12, 7, 11, 57, 51, 201, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 11, 57, 51, 201, DateTimeKind.Utc), IsActive = true, ModifiedBy = 10146063, TotalScore = 0 }
                    );
                });
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.LookUpTables.AssessmentLinkForm", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 12, 7, 11, 57, 51, 215, DateTimeKind.Utc));
