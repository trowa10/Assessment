...
namespace AssessmentPersistence.Migrations
{
    ...
    [Migration("20201207122253_AddDomAndDomElementAndDomtypeTable")]
    partial class AddDomAndDomElementAndDomtypeTable
    {
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentAnswer", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AnswersJson = "[{}]", ApproverTwwId = 0, AssessmentUserStatusId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), IsActive = true, ModifiedBy = 10146063, TotalScore = 0 }
                    );
                });
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentTemplate", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AssessmentCode = "PA2020", DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 853, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 853, DateTimeKind.Utc), EndDate = new DateTime(2020, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, ModifiedBy = 10146063, ScoreCriteriaId = 1, StartDate = new DateTime(2020, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Performance Appraisal", TypeId = 1, Version = "1.0", Year = 2020, isStash = false },
                        new { Id = 2, AssessmentCode = "SD2020", DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EndDate = new DateTime(2020, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, ModifiedBy = 10146063, ScoreCriteriaId = 1, StartDate = new DateTime(2020, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Salary Discussion", TypeId = 2, Version = "1.0", Year = 2020, isStash = false }
                    );
                });
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.AssessmentUserStatus", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999996, StatusId = 2, UserId = 99999992, UserRegionId = 1, formChanged = false },
                        new { Id = 2, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999995, StatusId = 1, UserId = 99999991, UserRegionId = 2, formChanged = false },
                        new { Id = 3, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 1111110, StatusId = 1, UserId = 99999999, UserRegionId = 1, formChanged = false },
                        new { Id = 4, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999999, StatusId = 2, UserId = 99999998, UserRegionId = 1, formChanged = false },
                        new { Id = 5, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999999, StatusId = 1, UserId = 99999997, UserRegionId = 2, formChanged = false },
                        new { Id = 6, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999999, StatusId = 0, UserId = 99999996, UserRegionId = 1, formChanged = false },
                        new { Id = 7, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999999, StatusId = 1, UserId = 99999995, UserRegionId = 2, formChanged = false },
                        new { Id = 8, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999999, StatusId = 2, UserId = 99999993, UserRegionId = 1, formChanged = false },
                        new { Id = 9, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999999, StatusId = 0, UserId = 99999994, UserRegionId = 1, formChanged = false },
                        new { Id = 10, AssessmentTemplateId = 1, DateCreated = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), DateModified = new DateTime(2020, 12, 7, 12, 22, 52, 854, DateTimeKind.Utc), EmployeeLevelId = 1, IsActive = true, LockedToUserId = 0, ModifiedBy = 10146063, ReportsTo = 99999996, StatusId = 1, UserId = 99999990, UserRegionId = 2, formChanged = false }
                    );
                });
            ...
            modelBuilder.Entity("AssessmentPersistence.Entities.LookUpTables.AssessmentLinkForm", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2020, 12, 7, 12, 22, 52, 865, DateTimeKind.Utc));
